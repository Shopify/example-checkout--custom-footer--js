...
- `src/Extension.js`, the source code for your extension.
- `src/Checkout.js`, the entry point for the extension's target on the Checkout page.
- `src/ThankYou.js`, the entry point for the extension's target on the Thank you page.
